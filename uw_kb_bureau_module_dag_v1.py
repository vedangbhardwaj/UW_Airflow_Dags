...
def run():
    import time
    config_var = Variable.get("underwriting_dags", deserialize_json=True)["bureau_module"]
...
run()
elapsed_time = et - st
print('Bureau module script execution time:', elapsed_time, 'seconds')   
